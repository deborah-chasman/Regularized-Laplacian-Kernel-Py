...
def main(argv):
	...
	try:
		...
		print >> sys.stderr, "Invalid lambda ('%s'). Please choose lambda > 0.0." % argv[3]
		return 2
	...
	print "# Read %d input scores from %s." % (len(input_scores), scoreFn)
